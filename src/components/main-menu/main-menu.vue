...
<template>
	<nav class="main-menu">
		...
		<ul class="menu-list" v-bind:class="{'isnot-show' : show }">
			...
			<li class="menu-item item-portfolio" @click="showSubMenu">
